...
<script lang="ts">
import { defineComponent, inject, onMounted, onUnmounted, ref, watch, watchEffect } from 'vue'
  ...
  setup(props) {
    ...
    function createSandbox() {
      ...
      proxy = new PreviewProxy({
        ...
        onConsole: (msg) => {
          // Forward iframe console messages to the browser console
          const method = msg.level as keyof Console
          // eslint-disable-next-line no-console
          if (typeof console[method] === 'function') console[method]('[Preview]', ...msg.args)
        },
      })
    ...
    function updatePreview() {
      ...
      try {
        ...
        Object.values(store.files).forEach(file => {
          ...
          void file.compiled?.js
          void file.compiled?.css
        })
